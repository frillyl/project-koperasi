...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-5">
                    <select class="form-control select2" name="akun" style="width: 100%;">
                        <option selected="selected">-- Pilih Akun --</option>
                        <?php foreach ($akun as $row) : ?>
                            <option value="<?= $row['id_akun']; ?>"><?= $row['nm_akun']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-lg-5">
                ...
                <div class="col-lg-2">
                    <button type="button" name="cari" class="btn btn-block bg-gradient-primary"><i class="fa-solid fa-magnifying-glass"></i> Cari</button>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-12">
